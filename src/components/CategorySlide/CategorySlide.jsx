        ...
        <div>
           <div className="group">
              <div className="border  group-hover:bg-red-400 flex flex-col justify-center items-center py-6 border-black/30  w-[170px] h-[145px] rounded ">
                ...
                >
                  <g clip-path="url(#clip0_12014_430)">
                    <path
            ...
            <div>
              ...
              <div className="border group-hover:bg-red-400 flex flex-col justify-center items-center py-6 border-black/30  w-[170px] h-[145px] rounded ">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_12014_953)">
                    <path
          ...
          <div>
              ...
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clip-path="url(#clip0_12014_530)">
                  <path
          ...
          <div>
            <div className='group'>
              ...
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clip-path="url(#clip0_12014_2101)">
                  <path
       ...
       <div>
          <div className='group'>
              ...
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clip-path="url(#clip0_12014_544)">
                  <path
        ...
        <div>
              ...
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clip-path="url(#clip0_12014_58)">
                  <path
