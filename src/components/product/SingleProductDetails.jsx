             ...
             <div className='grid grid-cols-6 gap-4 mt-20'>
                <div className='col-span-1 '>
...

                    {
                        ...
                        <div  key={idx} className='bg-[#F5F5F5] flex justify-center items-center'>
                ...
                <div className='col-span-2 text-start!'>
                    <h1 className=' font-semibold text-2xl text-start leading-6 p-4'>{singleProduct?.title}</h1>
                ...
                <Rating rating={singleProduct?.rating}/>
                   ...
                   <p className='font-secoundary text-2xl pb-6 '>${singleProduct?.price}</p>
